...
#Introduction (script 4)
In this script, we produce many of the figures and panels and analyses to help you visualize patterns in botanical collections across your region of interest. 

Note that you may need to run the phylogenetic diversity script before you can get the heatmaps to work in the panel plots. See SCRIPT. 
...
#Load data
You need 'dat', 'env.v' and the phylogenetic data loaded. If you just ran script 3 and it's all loaded in your environment, you're good to go.
```{r data}
...
load("/Users/elizabethlombardi/Desktop/Research/UNM/Herbarium collections patterns and gaps project/datastack_manuscript.Rdata")


write.csv(dat, "/Users/elizabethlombardi/Desktop/Research/UNM/Herbarium collections patterns and gaps project/dat.csv", row.names =TRUE)
